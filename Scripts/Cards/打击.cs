...
public class StrikeCard : CustomCardModel
{
    ...
    public StrikeCard() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
    ...
    // 卡面路径
    public override string PortraitPath => $"res://Chaos_Haru/images/cards/{nameof(StrikeCard)}.png";
}