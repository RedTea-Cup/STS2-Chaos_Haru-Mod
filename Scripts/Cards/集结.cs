...
public class JijieCard : CustomCardModel
{
    // 基础耗能
    ...
    public JijieCard() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    ...
    // 卡面路径
    public override string PortraitPath => $"res://Chaos_Haru/images/cards/{nameof(JijieCard)}.png";
}